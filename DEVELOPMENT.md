# TAKARA AI Development Guide

Welcome to the TAKARA AI development guide! This document will help you set up your development environment and understand how to work with the codebase. Whether you're fixing bugs, adding features, or just exploring the code, this guide will get you started.
...
2. This will open a new VSCode window with TAKARA AI loaded
...
TAKARA AI uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "TAKARA AI" from the dropdown
